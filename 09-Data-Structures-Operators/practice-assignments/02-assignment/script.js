...
const bookRating = thirdParty.goodreads.rating;

console.log('Third Book rating:', bookRating);

// Jonas's solution:
// const {thirdParty: {goodreads: {rating: bookRating}}} = books[0];
const {
  thirdParty: {
    goodreads: { rating: bookRating2 },
  },
} = books[0];

console.log('Third Book rating:', bookRating2);

// I missed the point, because I did not read this:
...
const functionArguments = [
  ...
  { title: 'Algorithms', author: 'Robert Sedgewick', year: '2011' },
];
...
printBookInfo(functionArguments[0]);
printBookInfo(functionArguments[1]);
